...
// ClassicPress // add_filter( 'the_content_feed', 'wp_staticize_emoji' );
...
// ClassicPress // add_filter( 'comment_text_rss', 'wp_staticize_emoji' );
add_filter( 'bloginfo_rss',       'ent2ncr',                    8 );
add_filter( 'the_author',         'ent2ncr',                    8 );
add_filter( 'the_guid',           'esc_url'                       );

// Email filters
// ClassicPress // add_filter( 'wp_mail', 'wp_staticize_emoji_for_email' );
...
// ClassicPress // add_action( 'wp_head', 'print_emoji_detection_script', 7 );
...
// ClassicPress // add_action( 'wp_print_styles', 'print_emoji_styles' );
...
// ClassicPress // add_action( 'admin_print_scripts', 'print_emoji_detection_script' );
add_action( 'admin_print_scripts',        'print_head_scripts',                      20    );
add_action( 'admin_print_footer_scripts', '_wp_footer_scripts'                             );
// ClassicPress // add_action( 'admin_print_styles', 'print_emoji_styles' );
